               ...
               <div class="col-md-5">
                  <div class="card p-3">
                     <div class="card-body">
                        ...
                        <p class="text-center text-secondary mb-4">请登录您的账号</p>
                            ...
                            <div class="col-lg-12">
                                ...
                                <?php ActiveForm::end(); ?>
                                    <div class="col-lg-12 mt-3">
                                        <p class="mb-0 text-center">还未有账号? <a href="<?php echo Yii::$app->getHomeUrl(); ?>?r=site%2Fsignup"> 注册</a></p>
                                        <p>    </p>
                                    <p class="text-center text-secondary mb-4">Don't have an account?<a href="<?php echo Yii::$app->getHomeUrl(); ?>?r=site%2Fsignup">  Sign Up</a></p>
                                </div>
                            </div>
                        </div>
